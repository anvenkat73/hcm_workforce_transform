 SELECT  WRKFCASG.ASSIGNMENT_ID AS ASSIGNMENT_ID , 
  WRKFCASG.EFFECTIVE_START_DATE AS PROMOTION_DATE , 
 	TO_DATE(SUBSTR('4712-12-31 00:00:00.0',1,19),'YYYY-MM-DD HH24:MI:SS') AS NEXT_PROMOTION_DATE	, 
 ...
 WHERE 	ACTION.ACTION_TYPE_CODE IN ('EMPL_WR_EMP', 'EMPL_ADD_EMP', 'EMPL_REHIRE','EMPL_ADD_CWK', 'EMPL_WR_CWK','EMPL_ADD_NWK','EMPL_ADD_PWK','EMPL_PROMOTION') GROUP BY  WRKFCASG.ASSIGNMENT_ID, WRKFCASG.EFFECTIVE_START_DATE,	TO_DATE(SUBSTR('4712-12-31 00:00:00.0',1,19),'YYYY-MM-DD HH24:MI:SS')
