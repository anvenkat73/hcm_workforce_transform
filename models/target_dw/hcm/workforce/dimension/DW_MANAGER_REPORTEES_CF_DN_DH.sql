 ...
 CASE WHEN PARSE_DATE('%Y-%m-%d', '$VAR_PARAM_GLOBAL_INITIAL_EXTRACT_DATE$') >  SPAN.EFFECTIVE_START_DATE  THEN PARSE_DATE('%Y-%m-%d', '$VAR_PARAM_GLOBAL_INITIAL_EXTRACT_DATE$') ELSE  SPAN.EFFECTIVE_START_DATE END AS DW_DATE_FROM, 
 SPAN.EFFECTIVE_END_DATE AS DW_DATE_TO, 
  CASE WHEN PARSE_DATE('%Y-%m-%d', '$VAR_PARAM_GLOBAL_INITIAL_EXTRACT_DATE$') >  SPAN.EFFECTIVE_START_DATE THEN 1 ELSE 0 END  AS DW_INITIAL_RECORD_IND
