 SELECT  CDD.MANAGER_ASSIGNMENT_ID AS MANAGER_ASSIGNMENT_ID , 
  ...
  TO_CHAR(CDD.MANAGER_ASSIGNMENT_ID)||'~'||TO_CHAR(DRVD.ASSIGNMENT_ID)||'~'||TO_CHAR(DRVD.EVENT_DATE,'YYYYMMDD')||'~'||TO_CHAR(DRVD.EVENT_ID) AS SOURCE_RECORD_ID      , 
 ...
 GROUP BY  CDD.MANAGER_ASSIGNMENT_ID, DRVD.ASSIGNMENT_ID, DRVD.EVENT_DATE, DRVD.EVENT_ID, TO_CHAR(CDD.MANAGER_ASSIGNMENT_ID)||'~'||TO_CHAR(DRVD.ASSIGNMENT_ID)||'~'||TO_CHAR(DRVD.EVENT_DATE,'YYYYMMDD')||'~'||TO_CHAR(DRVD.EVENT_ID)
