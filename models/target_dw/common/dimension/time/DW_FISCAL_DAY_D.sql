 SELECT  DISTINCT  GLFISCALPERIODPVO.FISCALPERIODSETNAME AS FISCAL_PERIOD_SET_NAME , 
  ...
  GLFISCALPERIODPVO.FISCALPERIODSETNAME||'~'||GLFISCALPERIODPVO.FISCALPERIODTYPE||'~'||TO_CHAR('~No Value~')||'~'||TO_CHAR(-99999) AS SOURCE_RECORD_ID , 
   '~NOVALUE~' AS FISCAL_PERIOD_SORT_KEY , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_DAY_DATE , 
  '~NOVALUE~' AS FISCAL_DAY_CODE , 
  '~NOVALUE~' AS ADJUSTMENT_PERIOD_FLAG , 
  -99999 AS FISCAL_PERIOD_NUMBER , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_PERIOD_START_DATE , 
  -99999 AS FISCAL_PERIOD_START_DATE_ID , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_PERIOD_END_DATE , 
  -99999 AS FISCAL_PERIOD_END_DATE_ID , 
  -99999 AS FISCAL_QUARTER_NUMBER , 
  '~NOVALUE~' AS FISCAL_QUARTER_CODE , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_QUARTER_START_DATE , 
  -99999 AS FISCAL_QUARTER_START_DATE_ID , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_QUARTER_END_DATE , 
  -99999 AS FISCAL_QUARTER_END_DATE_ID , 
  -99999 AS FISCAL_HALF_NUMBER , 
  -99999 AS FISCAL_YEAR_NUMBER , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_YEAR_START_DATE , 
  -99999 AS FISCAL_YEAR_START_DATE_ID , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_YEAR_END_DATE , 
  ...
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_WEEK_START_DATE , 
  -99999 AS FISCAL_WEEK_START_DATE_ID , 
  TO_TIMESTAMP('1901-01-01 00:00:00.0','YYYY-MM-DD HH24:MI:SS.FF9') AS FISCAL_WEEK_END_DATE , 
